import { FileMimesTypes } from "@ctypes";
 ...
 */
export type MethodPropertyFileOptions = {
 ...
 */
export type MethodPropertyValueOptions = Joi.Schema | {
    /**
 ...
 */
export type MethodPropertyOptions<MethodType extends "body" | "query"> = {
    /**
 ...
 * @template MethodType - The type of the method (e.g., "body" or "query").
 */
export interface MethodProperties<MethodType extends "body" | "query" = "query"> {
    /**
 ...
 */
export type GenericMethodOptions<
    MongooseModel extends any,
 ...
 * @template DocumentType - The document type.
 */
export type GetOneMethodProps<MongooseModel extends any, DocumentType extends any> = {
    /**
 ...
 * @template DocumentType - The document type.
 */
export type GetAllMethodProps<MongooseModel extends any, DocumentType extends any> = {
    /**
 ...
 * @template DocumentType - The document type.
 */
export type PostMethodProps<MongooseModel extends any, DocumentType extends any> = {
    /**
...
export type UpdateMethodProps<MongooseModel extends any, DocumentType extends any> = {
    query: MethodProperties;
    body: MethodProperties<"body">;
} & GenericMethodOptions<MongooseModel, DocumentType, true>;
